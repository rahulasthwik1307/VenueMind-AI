...
- **Type-safe throughout** — strict TypeScript, Zod validation on every AI response before it reaches the UI, no `any`.
...
| AI Command Center  | Live Incidents     |
| ------------------ | ------------------ |
| _[Add screenshot]_ | _[Add screenshot]_ |

| Accessibility Dispatch Tool | Operations Timeline |
| --------------------------- | ------------------- |
| _[Add screenshot]_          | _[Add screenshot]_  |
...
The following are architected for but not yet implemented — intentionally scoped out to keep this submission focused and deep rather than broad:

- [ ] Real IoT/telemetry integration (replacing the simulation engine)
- [ ] WebSocket-based live multi-client sync
- [ ] Multi-stadium support
- [ ] Historical playback / scrubber timeline
