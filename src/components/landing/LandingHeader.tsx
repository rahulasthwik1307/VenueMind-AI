  ...
  return (
    <header
      className={cn(
        ...
        'flex items-center justify-between px-2 sm:px-6 md:px-10',
    ...
    >
      ...
      <Link
        ...
        className="flex items-center gap-1.5 sm:gap-3 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-sm shrink-0 animate-fade-in"
        aria-label="VenueMind AI — home"
      >
        <div
          className={cn(
            "w-6 h-6 sm:w-8.5 sm:h-8.5 rounded-lg bg-primary flex items-center justify-center shrink-0",
          ...
          aria-hidden="true"
        >
          <Cpu size={14} strokeWidth={2.25} className="text-white dark:text-[#0b0f19] transition-transform duration-200 group-hover:scale-105 sm:w-4.5 sm:h-4.5" />
        </div>
        <span className="text-[13px] sm:text-base font-extrabold text-foreground tracking-tight leading-none">
      ...
      <div className="flex items-center gap-1.5 sm:gap-4 shrink-0">
        ...
        <Link
          ...
          className={cn(
            ...
            'px-2 sm:px-4.5 py-1.5 text-[9px] sm:text-xs border border-primary-hover ring-1 ring-white/10',
