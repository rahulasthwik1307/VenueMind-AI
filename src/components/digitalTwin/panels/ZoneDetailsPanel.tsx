          ...
          >
            ...
            <div className="shrink-0 w-52 overflow-y-auto space-y-1.5">
              ...
              {incidentsInZone.filter((i) => i.status !== 'resolved').length === 0 ? (
                <div className="text-[10px] text-(--foreground-subtle) text-center py-2 px-2 border border-dashed border-(--border) rounded-md min-h-13 flex items-center justify-center text-wrap wrap-break-word">
