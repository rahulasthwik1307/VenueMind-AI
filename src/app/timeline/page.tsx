        ...
        <div className="bg-(--surface-1) border border-(--border) rounded-card p-6 min-h-120 flex flex-col justify-between">
          <div>
            <SectionHeader
              ...
              description="Full historic log of detections, analyses, dispatches, and resolutions across Al Bayt Stadium"
            />
          </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center border border-dashed border-(--border) rounded-md bg-(--surface-2) p-10 text-center my-6">
            <Clock size={36} className="text-(--primary) opacity-65 mb-3" />
            <h2 className="text-sm font-bold text-(--foreground) uppercase tracking-wide">Historical Timeline Feed</h2>
            <p className="text-xs text-(--foreground-muted) max-w-lg mt-1.5 leading-relaxed">
              Consolidated chronological dashboard log of all operations actions. Incident-specific timelines are visible in the details drawer.
            </p>
